...
import { JWTAuthenticationStrategy, RefreshTokenRepository, RefreshtokenService, SecuritySpecEnhancer } from '@loopback/authentication-jwt';
...
export class JWTAuthenticationComponent implements Component {
  bindings: Binding[] = [
    ...
    Binding.bind(UserServiceBindings.USER_REPOSITORY).toClass(UsersRepository),
